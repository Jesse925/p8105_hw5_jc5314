...
*Comments:* Based on the plot, it can be seen that the power of the test was increased when the effect size increased. More specifically, the power was very small when the true value of $\beta_1$ was less than 2, and the power was large and closed to 1 when the true value of $\beta_1$ was greater than 5.
